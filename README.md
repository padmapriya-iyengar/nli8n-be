...
```
cd existing_repo
git remote add origin https://gitlab.com/padmapriya-iyengar/agc-node-api.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/padmapriya-iyengar/agc-node-api/-/settings/integrations)
